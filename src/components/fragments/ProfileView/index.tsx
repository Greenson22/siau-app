    ...
    <Card className="max-w-3xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="flex-1">
                <p className="text-2xl font-bold text-gray-800">Ariel Tatum</p>
                <p className="text-indigo-600">S1 Teologi</p>
                <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                    <div className="flex items-center gap-2"><CreditCard size={16} className="text-gray-500" /><span className="font-semibold">NIM:</span><span>202201001</span></div>
                    ...
                    <div className="flex items-center gap-2"><Mail size={16} className="text-gray-500" /><span>ariel.tatum@sttis.ac.id</span></div>
                    <div className="flex items-center gap-2"><Phone size={16} className="text-gray-500" /><span>081234567890</span></div>
                </div>
            </div>
        </div>
    </Card>
