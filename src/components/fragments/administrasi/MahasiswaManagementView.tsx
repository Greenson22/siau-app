        ...
        <Card>
            ...
            <div className="flex justify-between items-center mt-6">
                ...
                <div className="flex items-center gap-2">
                    <Button onClick={() => setCurrentPage(p => p - 1)} disabled={currentPage === 0 || isLoading} variant="ghost" className="!p-2">
                        <ChevronLeft size={20}/>
                    </Button>
                    <Button onClick={() => setCurrentPage(p => p + 1)} disabled={currentPage >= (mahasiswaPage?.totalPages || 1) - 1 || isLoading} variant="ghost" className="!p-2">
